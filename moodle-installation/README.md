...
**✅ Новое в 2025:** Все исправления JavaScript/CSS, CSP и недостающих обработчиков интегрированы в основную установку!
...
2. **02-install-webserver.sh** - Установка и настройка Nginx + PHP 8.3 + CSP + обработчики font.php/image.php
...
- **fix-nginx-moodle.sh** - Исправление конфигурации Nginx для правильной загрузки JS/CSS (HTTP)
- **fix-nginx-ssl-moodle.sh** - Исправление SSL конфигурации Nginx для HTTPS сайтов
- **fix-moodle-csp.sh** - Исправление Content Security Policy и добавление обработчиков для font.php/image.php
...
# 🎯 АВТОМАТИЧЕСКИ ВКЛЮЧЕНО в script 02-install-webserver.sh
...
# 🔧 РУЧНОЕ ИСПРАВЛЕНИЕ (если установка была без интегрированных исправлений):
# Для HTTP сайтов:
sudo ./fix-nginx-moodle.sh

# Для HTTPS сайтов (SSL конфигурация):
sudo ./fix-nginx-ssl-moodle.sh

# ❌ ДОПОЛНИТЕЛЬНАЯ ПРОБЛЕМА: Content Security Policy и недостающие обработчики
# Проявления:
# - "Refused to evaluate a string as JavaScript because 'unsafe-eval' is not an allowed source"
# - "GET /theme/font.php/boost/core/xxx/fa-solid-900.woff2 net::ERR_ABORTED 404"
# - "Cannot read properties of undefined (reading 'one')"

# 🎯 РЕШЕНИЕ CSP И НЕДОСТАЮЩИХ ОБРАБОТЧИКОВ:
sudo ./fix-moodle-csp.sh
...
# Проявления: "conflicting server name lms.rtti.tj on 0.0.0.0:80, ignored"
...
sudo nano /etc/nginx/sites-available/lms.rtti.tj
