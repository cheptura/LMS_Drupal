...
4. **04-install-alertmanager.sh** - Установка системы уведомлений
5. **05-install-exporters.sh** - Установка экспортеров метрик (Node, Nginx, PostgreSQL)
6. **06-configure-monitoring.sh** - Настройка конфигураций и правил
7. **07-setup-dashboards.sh** - Импорт готовых дашбордов Grafana
8. **08-configure-alerts.sh** - Настройка правил алертов и уведомлений
9. **09-install-ssl.sh** - Установка SSL сертификатов для веб-интерфейсов
10. **10-final-setup.sh** - Финальная настройка и тестирование
