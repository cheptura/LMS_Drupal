...
3. **03-install-php.sh** - Установка PHP 8.3 с модулями для Drupal
4. **04-install-postgresql.sh** - Установка PostgreSQL 16 СУБД
5. **05-configure-database.sh** - Создание базы данных и пользователя
6. **06-install-composer.sh** - Установка Composer для управления пакетами
7. **07-download-drupal.sh** - Загрузка и установка Drupal 11 LTS
8. **08-configure-drupal.sh** - Настройка конфигурации и модулей
