...
- **Moodle 5.0.2 LMS** - современная платформа для проведения онлайн-обучения с ИИ инструментами
...
├── cloud-deployment/
│   ├── install-moodle-cloud.sh   # Автоматическая установка Moodle 5.0.2 в облаке
│   ├── install-drupal-cloud.sh   # Автоматическая установка Drupal 11 в облаке
│   └── cloud-backup.sh           # Облачное резервное копирование
...
- Автоматизация учебных процессов с ML
...
### Платформы
- **Moodle**: 5.0.2 (с ИИ инструментами и улучшенной производительностью)
